...
export default function Contact() {
	...
	return (
		<div className="w-full h-[150vh] flex flex-col items-center justify-center bg-primary gap-20">
			...
			<div className="w-[80%] xm:w-[90%] sm:w-[90%] md:w-[90%] lg:w-[90%] padding-x py-[150px] md:py-[80px] sm:text-[40px] xm:text-[40px flex gap-6 border-4 border-white/20 bg-black rounded-lg">
				...
				<div className="flex flex-1 flex-col gap-10">
					<div className="w-full flex flex-col border-b border-[#DBCAB6] gap-2">
						<h1 className="text-[#DBCAB6] text-md font-Poppins text-[22px]">
							Name
						</h1>
						<input
							type="text"
							className="bg-transparent border-none outline-none text-[#DBCAB6] text-[18px] pb-1"
						/>
					</div>
					<div className="w-full flex flex-col border-b border-[#DBCAB6] gap-2">
						<h1 className="text-[#DBCAB6] text-md font-Poppins text-[22px]">
