...
export default function HorizontalScrollCarousel() {
	...
	return (
		<section
			ref={targetRef}
			className="relative h-[400vh] bg-[#BBB0D2] line-draw">
			<div className="sticky top-0 flex h-screen items-center overflow-hidden border svg-container">
				<motion.div
					...
					<svg
						...
						fill="none"
						className="w-auto h-auto lg:h-[1400px] td:h-[1300px] top-[-110%] td:top-[-90%] td:left-[10%] lg:left-[13%] lg:top-[-140%] overflow-visible left-[5%] shrink-0 absolute z-[9]">
						<path
							className="path"
							ref={pathRef}
